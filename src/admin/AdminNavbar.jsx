...
import {LogOut, Users, ClipboardList, Settings2, AppWindowMac, UserRoundCheck, Package, PlusCircle } from "lucide-react";
...
const AdminSidebar = () => {
  ...
  return (
    <aside className="rounded-xl w-64 border-[#e7e2e2] bg-white border shadow-customm fixed top-[20px] left-[20px] bottom-[20px] p-6">
      ...
      <nav className="flex flex-col gap-2">
        ...
        <NavLink to="/admin/products" end className={navLinkClass}>
          <Package size={18} />
          Products
        </NavLink>
